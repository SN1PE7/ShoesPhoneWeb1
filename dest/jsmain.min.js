!(function (e, t) {
  ...
  "object" == typeof module && "object" == typeof module.exports
    ...
    : t(e);
})("undefined" != typeof window ? window : this, function (E, z) {
  "use strict";
  function y(e) {
  ...
  var e = (function (z) {
      ...
      try {
        T.apply((t = Y.call(c.childNodes)), c.childNodes),
        ...
        if (!i && (E(t), (t = t || C), S)) {
          if (11 !== h && (a = ue.exec(e)))
            if ((o = a[1])) {
              ...
              if (a[2]) return T.apply(n, t.getElementsByTagName(e)), n;
              if (
                (o = a[3]) &&
                d.getElementsByClassName &&
                t.getElementsByClassName
              )
                return T.apply(n, t.getElementsByClassName(o)), n;
            }
          if (
            d.qsa &&
            !m[e + " "] &&
            ...
            if (((u = e), (c = t), 1 === h && (ie.test(e) || ne.test(e)))) {
              for (
                ((c = (ce.test(e) && me(t.parentNode)) || t) === t &&
                  d.scope) ||
                  ((s = t.getAttribute("id"))
                    ? (s = s.replace(he, M))
      ...
      (j.contains = function (e, t) {
        return (e.ownerDocument || e) != C && E(e), g(e, t);
      }),
      (j.attr = function (e, t) {
        (e.ownerDocument || e) != C && E(e);
        var n = x.attrHandle[t.toLowerCase()],
          n = n && G.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !S) : void 0;
        return void 0 !== n
          ? n
          : d.attributes || !S
          ? e.getAttribute(t)
                        ...
                        for (
                          f =
                            (a =
                              (i =
                                (o =
                                  (r = (s = c)[k] || (s[k] = {}))[s.uniqueID] ||
                                  (r[s.uniqueID] = {}))[p] || [])[0] === D &&
                              i[1]) && i[2],
                            s = a && c.childNodes[a];
                          (s = (++a && s && s[u]) || ((f = a = 0), l.pop()));
        ...
        for (
          var i,
            ...
            c = [
              function (e, t, n) {
                e =
                  (!r && (n || t !== w)) || ((i = t).nodeType ? l : u)(e, t, n);
                return (i = null), e;
              },
            ];
          a < o;
              ...
              return (function e(f, p, g, m, v, t) {
                return (
                  ...
                  P(function (e, t, n, i) {
                    ...
                    } else (d = xe(d === t ? d.splice(u, d.length) : d)), v ? v(null, t, d, i) : T.apply(t, d);
                  })
                );
              })(
                1 < a && be(c),
      ...
      return (
        ...
        (f = j.tokenize =
          function (e, t) {
            ...
            return t ? s.length : s ? j.error(e) : U(e, a).slice(0);
          }),
        (H = j.compile =
          function (e, t) {
            var n,
              ...
              (s = $(
                ...
                (i = function (e, t, n, i, o) {
                  ...
                  for (
                    ...
                    if (b && r) {
                      for (
                        s = 0, t || r.ownerDocument == C || (E(r), (n = !S));
                        (a = m[s++]);
          ...
          function (e, t, n, i) {
            ...
            if (((n = n || []), 1 === c.length)) {
              if (
                ...
                if (!(t = (x.find.ID(s.matches[0].replace(L, h), t) || [])[0]))
                  return n;
              ...
              for (
                ...
                if (
                  ...
                  (i = l(
                    ...
                    (ce.test(r[0].type) && me(t.parentNode)) || t
                  ))
                ) {
  ...
  (S.filter = function (e, t, n) {
    ...
    S.fn.extend({
      ...
      is: function (e) {
        return !!K(this, "string" == typeof e && Y.test(e) ? S(e) : e || [], !1)
          .length;
      },
    });
  var Z,
  ...
  S.extend({
    ...
    S.fn.extend({
      data: function (n, e) {
        ...
        if (
          this.length &&
          ((o = u.get(r)), 1 === r.nodeType) &&
          !x.get(r, "hasDataAttrs")
        ) {
          for (t = s.length; t--; )
            s[t] &&
  ...
  function me(e, t) {
    return (
      ...
      ("" === e.style.display && D(e) && "none" === S.css(e, "display"))
    );
  }
  ...
  w.getRootNode &&
    (D = function (e) {
      return (
        S.contains(e.ownerDocument, e) || e.getRootNode(ye) === e.ownerDocument
      );
    });
  function be(e, t, n, i) {
    var o,
  ...
  function De(e, t, n, i, o) {
    for (
      ...
      if ((r = e[d]) || 0 === r)
        if ("object" === p(r)) S.merge(h, r.nodeType ? [r] : r);
        else if (ke.test(r)) {
          for (
            ...
            s = s.lastChild;
          S.merge(h, s.childNodes), ((s = c.firstChild).textContent = "");
        } else h.push(t.createTextNode(r));
    for (c.textContent = "", d = 0; (r = h[d++]); )
      if (i && -1 < S.inArray(r, i)) o && o.push(r);
      else if (((l = D(r)), (s = L(c.appendChild(r), "script")), l && Se(s), n))
  ...
  function Pe(e, o, r) {
    r
      ...
      : void 0 === x.get(e, o) && S.event.add(e, o, s);
  }
  (S.event = {
    global: {},
        ...
        for (u = (t = (t || "").match(k) || [""]).length; u--; )
          if (
            ...
            s &&
              ...
              delete l[f]);
          } else for (f in l) S.event.remove(e, f + t[u], n, i, !0);
    ...
    dispatch: function (e) {
      var t,
        ...
        a = S.event.fix(e),
        e = (x.get(this, "events") || Object.create(null))[a.type] || [],
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          e = this || e;
          return (
            we.test(e.type) && e.click && l(e, "input") && Pe(e, "click", s), !1
          );
        },
        trigger: function (e) {
          e = this || e;
          return (
            we.test(e.type) && e.click && l(e, "input") && Pe(e, "click"), !0
          );
        },
        _default: function (e) {
          e = e.target;
  ...
  function j(n, i, o, r) {
    ...
    var e,
      ...
      f = i[0],
      p = y(f);
    if (p || (1 < h && "string" == typeof f && !m.checkClone && qe.test(f)))
      return n.each(function (e) {
        var t = n.eq(e);
        p && (i[0] = f.call(this, e, t.html())), j(t, i, o, r);
      });
    if (
      h &&
      ((t = (e = De(i, n[0].ownerDocument, !1, n, r)).firstChild),
      1 === e.childNodes.length && (e = t),
      t || r)
    ) {
      for (a = (s = S.map(L(e, "script"), Me)).length; c < h; c++)
        (l = e),
          c !== d &&
            ((l = S.clone(l, !0, !0)), a) &&
          ...
          o.call(n[c], l, c);
      if (a)
        for (u = s[s.length - 1].ownerDocument, S.map(s, Oe), c = 0; c < a; c++)
          (l = s[c]),
            Ce.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : G(l.textContent.replace(_e, ""), l, u));
    }
    return n;
  }
  function He(e, t, n) {
    for (var i, o = t ? S.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || S.cleanData(L(i)),
        i.parentNode &&
          (n && D(i) && Se(L(i, "script")), i.parentNode.removeChild(i));
    return e;
  }
  S.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (s = L(c), i = 0, o = (r = L(e)).length; i < o; i++)
          (a = r[i]),
      ...
      if (t)
        if (n)
          for (r = r || L(e), s = s || L(c), i = 0, o = r.length; i < o; i++)
            Fe(r[i], s[i]);
        else Fe(e, c);
      return 0 < (s = L(c, "script")).length && Se(s, !h && L(e, "script")), c;
    },
    ...
    S.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (S.cleanData(L(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
  ...
  function ht(e, t, n, i, o, r) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (l += S.css(e, n + d[s], !0, o)),
        i
          ? ("content" === n && (l -= S.css(e, "padding" + d[s], !0, o)),
            "margin" !== n && (l -= S.css(e, "border" + d[s] + "Width", !0, o)))
          : ((l += S.css(e, "padding" + d[s], !0, o)),
            "padding" !== n
              ? (l += S.css(e, "border" + d[s] + "Width", !0, o))
              : (a += S.css(e, "border" + d[s] + "Width", !0, o)));
    return (
      !i &&
        0 <= r &&
        (l +=
  ...
  function dt(e, t, n) {
    ...
    return (
      ((!m.boxSizingReliable() && o) ||
        ...
        ((o = "border-box" === S.css(e, "boxSizing", !1, i)), (r = a in e)) &&
        (s = e[a]),
      (s = parseFloat(s) || 0) +
        ht(e, t, n || (o ? "border" : "content"), r, i, s) +
        "px"
    );
  }
  ...
  S.extend({
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          u = e.style;
        if (
          (l || (t = rt(a)), (s = S.cssHooks[t] || S.cssHooks[a]), void 0 === n)
        )
    ...
    S.each({ margin: "", padding: "", border: "Width" }, function (o, r) {
      (S.cssHooks[o + r] = {
        ...
        "margin" !== o && (S.cssHooks[o + r].set = ct);
    }),
    S.fn.extend({
      css: function (e, t) {
        return h(
  ...
  function I(o, e, t) {
    ...
    for (i in m)
      if (
        ...
        (u = S.cssHooks[s]) && "expand" in u)
      )
        for (i in ((l = u.expand(l)), delete m[s], l))
          i in m || ((m[i] = l[i]), (v[i] = a));
      else v[s] = a;
    for (; c < h; c++)
      if ((n = I.prefilters[c].call(p, o, g, p.opts)))
        return (
          y(n.stop) &&
            (S._queueHooks(p.elem, p.opts.queue).stop = n.stop.bind(n)),
          n
        );
    return (
      S.map(g, bt, p),
      ...
      S.fx.timer(S.extend(f, { elem: o, anim: p, queue: p.opts.queue })),
      p
    );
  }
  (S.Animation = S.extend(I, {
    tweeners: {
      "*": [
        function (e, t) {
    ...
    tweener: function (e, t) {
      for (
        var n, i = 0, o = (e = y(e) ? ((t = e), ["*"]) : e.match(k)).length;
        i < o;
        i++
      )
        (n = e[i]),
        ...
        if ((l = !S.isEmptyObject(t)) || !S.isEmptyObject(d))
          ...
          d))
            l ||
              ...
              p && T([e], !0),
              h.done(function () {
                for (i in (p || T([e]), x.remove(e, "fxshow"), d))
                  S.style(e, i, d[i]);
              })),
              (l = bt(p ? g[i] : 0, i, h)),
              i in g ||
  ...
  S.fn.extend({
    ...
    S.fn.extend({
      addClass: function (t) {
        ...
        if (y(t))
          return this.each(function (e) {
            S(this).addClass(t.call(this, e, _(this)));
          });
        if ((e = St(t)).length)
          for (; (n = this[a++]); )
            if (((s = _(n)), (i = 1 === n.nodeType && " " + q(s) + " "))) {
              for (r = 0; (o = e[r++]); )
                i.indexOf(" " + o + " ") < 0 && (i += o + " ");
      ...
      removeClass: function (t) {
        ...
        if (y(t))
          return this.each(function (e) {
            S(this).removeClass(t.call(this, e, _(this)));
          });
      ...
      toggleClass: function (o, t) {
        ...
        return "boolean" == typeof t && s
          ...
          ? this.each(function (e) {
              S(this).toggleClass(o.call(this, e, _(this), t), t);
            })
          : this.each(function () {
              var e, t, n, i;
              if (s)
                for (t = 0, n = S(this), i = St(o); (e = i[t++]); )
                  n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
              else
                (void 0 !== o && "boolean" != r) ||
                  ((e = _(this)) && x.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
      ...
      hasClass: function (e) {
        for (var t, n = 0, i = " " + e + " "; (t = this[n++]); )
          if (1 === t.nodeType && -1 < (" " + q(_(t)) + " ").indexOf(i))
            return !0;
        return !1;
      },
    });
      ...
      (S.extend(S.event, {
        trigger: function (e, t, n, i) {
          ...
          if (
            ...
            if (!i && !u.noBubble && !g(n)) {
              for (
                s = u.delegateType || d, Tt.test(s + d) || (p = p.parentNode);
                p;
                p = p.parentNode
              )
                h.push(p), (r = p);
        ...
        if (
          ...
          try {
            (o.href = p.url),
              (o.href = o.href),
              (p.crossDomain =
                Ut.protocol + "//" + Ut.host != o.protocol + "//" + o.host);
          } catch (e) {
            p.crossDomain = !0;
          }
        }
          ...
          p.hasContent
            ...
            : ((o = p.url.slice(u.length)),
              p.data &&
                ...
                ((u += (jt.test(u) ? "&" : "?") + p.data), delete p.data),
              !1 === p.cache &&
                ((u = u.replace(Mt, "$1")),
                (o = (jt.test(u) ? "&" : "?") + "_=" + Lt.guid++ + o)),
              (p.url = u + o)),
          p.ifModified &&
            (S.lastModified[u] &&
              x.setRequestHeader("If-Modified-Since", S.lastModified[u]),
            S.etag[u]) &&
            x.setRequestHeader("If-None-Match", S.etag[u]),
    ...
    Kt =
      (S.ajaxSetup({
        ...
        jsonpCallback: function () {
          var e = Yt.pop() || S.expando + "_" + Lt.guid++;
          return (this[e] = !0), e;
        },
      }),
      S.ajaxPrefilter("json jsonp", function (e, t, n) {
        ...
        if (s || "jsonp" === e.dataTypes[0])
          return (
            ...
            n.always(function () {
              void 0 === o ? S(E).removeProp(i) : (E[i] = o),
      ...
      (S.offset = {
        setOffset: function (e, t, n) {
          ...
          "static" === a && (e.style.position = "relative"),
            ...
            null != (t = y(t) ? t.call(e, n, S.extend({}, r)) : t).top &&
              (u.top = t.top - r.top + o),
      ...
      S.each(["top", "left"], function (e, n) {
        S.cssHooks[n] = Ze(m.pixelPosition, function (e, t) {
          if (t)
            return (t = Ke(e, n)), Ye.test(t) ? S(e).position()[n] + "px" : t;
        });
      }),
  ...
  return (
    (S.noConflict = function (e) {
      return E.$ === S && (E.$ = en), e && E.jQuery === S && (E.jQuery = Zt), S;
    }),
    void 0 === z && (E.jQuery = E.$ = S),
    S
  );
}),
  (function (t, n) {
  ...
  (function (e, t) {
    ...
    function E(e) {
      if (
        ...
        for (
          var r = (o.isBorderBox = "border-box" == t.boxSizing), s = 0;
          s < y;
          s++
        ) {
          var a = v[s],
        ...
        var u = o.paddingLeft + o.paddingRight,
          ...
          p = r && x,
          g = m(t.width),
          g = (!1 !== g && (o.width = g + (p ? 0 : u + d)), m(t.height));
        return (
          !1 !== g && (o.height = g + (p ? 0 : c + f)),
          (o.innerWidth = o.width - (u + d)),
          (o.innerHeight = o.height - (c + f)),
        ...
        l.docReady(function () {
          ...
          t.forEach(function (e) {
            ...
            try {
              ...
              return void (
                u &&
                u.error("Error parsing " + i + " on " + e.className + ": " + t)
              );
            }
            n = new s(e, t);
            r && r.data(e, a, n);
    ...
    function f(e, t) {
      ...
      if (i) {
        if (((this.element = i), this.element.flickityGUID))
          return (n = d[this.element.flickityGUID]).option(t), n;
        r && (this.$element = r(this.element)),
          (this.options = s.extend({}, this.constructor.defaults)),
          this.option(t),
          this._create();
      } else u && u.error("Bad element for Flickity: " + (i || e));
    }
    (f.defaults = {
      accessibility: !0,
      cellAlign: "center",
    ...
    return (
      ...
      (i.dragEndBoostSelect = function () {
        ...
        return void 0 === this.previousDragX ||
          ...
          ? 0
          : ((e = this.getSlideDistance(-this.dragX, this.selectedIndex)),
  ...
  (function (t, n) {
    ...
    function s(e, t, n) {
      ...
      return this instanceof s
        ? (i = "string" == typeof (i = e) ? document.querySelectorAll(e) : i)
          ? ((this.elements =
              ((o = i),
              Array.isArray(o)
                ? o
